...
export const insertImportMovie = async (request, response, next) => {
  ...
  try {
    ...
    console.log(locationPath + importPoster);
    console.log(locationPath + importBanner);
    // process.exit();
    ...
    const tagsArray = genreNames
      ...
      const upcomingData = new movieSchm({
        ...
        categories: [],
        tags: tagsArray,
        poster_img: importPoster === undefined ? '' : locationPath + importPoster,
        banner_img: importBanner === undefined ? '' : locationPath + importBanner,
...
export const insertMovie = async (request, response, next) => {
  ...
  try {
    ...
    const upcomingData = new movieSchm({
      ...
      poster_img: namedFiles.poster_img  === undefined ? request.body.URLposter : namedFiles.poster_img,
      banner_img: namedFiles.banner_img === undefined ? request.body.URLbanner : namedFiles.banner_img,
